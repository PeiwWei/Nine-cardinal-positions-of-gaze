...
from model.Resnet.model import resnet50 as create_model
...
def main(args):
    ...
    model = create_model(num_classes=3, include_top=True).to(device)
    ...
    print(best_acc)
    torch.save(model.state_dict(), "./save_weights/ICSA_TR_two" + str(args.epochs) + '_BestAcc_' + str(best_acc) + '.pkl')
