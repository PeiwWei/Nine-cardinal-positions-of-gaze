...
# depth：重复堆叠encoder的层数
class VisionTransformer(nn.Module):
    def __init__(self, img_size=[192, 576], patch_size=[16,16], in_c=3, num_classes=3,
                 embed_dim=768, depth=12, num_heads=12, mlp_ratio=1.0, qkv_bias=True,
        ...
        self.num_tokens = 0 # 不使用cls_token
        ...
        if self.dist_token is not None:
            nn.init.ormal_(self.dist_token, std=0.02)
...
def vit_base_patch16_224_in21k(num_classes: int = 3, has_logits: bool = True):
    """
    ...
    """
    model = VisionTransformer(img_size=[192, 576],
                              patch_size=[16, 16],
                              embed_dim=768,
                              depth=12,
                              num_heads=12,
